// SummarizeArticle story implementation
'use server';

/**
 * @fileOverview Summarizes a news article into a concise overview.
 *
...
const SummarizeArticleInputSchema = z.object({
  articleContent: z.string().describe('The full content of the news article to summarize.'),
});
...
const summarizeArticlePrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following news article in a concise manner, highlighting the main points:\n\n{{{articleContent}}}`,
});
